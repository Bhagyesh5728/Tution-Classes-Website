                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                  <h2 data-animation="fadeInLeft" data-delay="0.2s" style="color: white; font-size: 50px; font-style: bold;">Welcome <br><?php echo $r['name']; }?></h2>
...
to learn with us</h2>
        ...
        <section class="about-area3 fix">
          ...
          <h2   style="font-size: 35px;  font-family: serif; color: green; font-size: 25px; text-align: center; "><span style="color: red;">"</span> Education Is The Most Powerful Weapon<br>
                            Which You Can Use To Change The World  <span style="color: red;">"</span> </h2>
        <!-- About Area End -->
        <!--? Team -->
                ...
                <div class="single-slider slider-height d-flex align-items-center">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h2 data-animation="fadeInLeft" data-delay="0.2s" style="color: white; font-size: 50px; font-style: bold;">Welcome To<br>The Tapasvi-Classes</h2>
