...
<body>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">ADD Notification</h1>
                                    <!-- breadcrumb Start-->
        ...
        <form method="post">
            ...
            <div align="center" ><textarea name="msg" placeholder="Enter Message Here" ></textarea></div>
            
     <div><div align="center"><button name="send"  class="btn btn-info add-new" >Send</button>
           &nbsp;&nbsp;&nbsp;
        <a href="view_msg.php"><button class="btn btn-info add-new" >View Message</button></a></div>
<br><br>
</form>
        <?php
        if(isset($_POST['send']))
        {
            $msg=$_POST['msg'];
            include "conect.php";
            mysqli_query($con,"insert into notification(msg) values('$msg')");
            echo "<script>alert('Your Message Is Succesfully Send')</script>";        
        }
        ?>
