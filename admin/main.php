                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="main.php"><img src="assets/img/logo/TAPSVI_CLASSES-removebg-preview.png" alt="" height="105px" width="100px"></a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                  <h2 data-animation="fadeInLeft" data-delay="0.2s" style="color: white; font-size: 50px; font-style: bold;">Welcome <br><?php echo $r['username']; }?></h2>
