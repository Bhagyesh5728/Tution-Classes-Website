                                            ...
                                            <li class="active"  ><a href="main.php"><span id="k">Home</span> </a></li>
                                             <li class="active"  ><a href="ADD Students.php"><span id="k">ADD Students</span> </a></li>
                                                <li><a href="ADD Photos.php"><span id="k"> ADD Photos</span></a></li>
                                                   <li><a href="ADD Result.php"><span id="k"> ADD Result</span></a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">ADD Result</h1>
                                    <!-- breadcrumb Start-->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb" style="background-color: transparent;">
                                            <li class="breadcrumb-item"><a href="main.php">Home</a></li>
                                            <li class="breadcrumb-item"><a href="ADD Result.php">ADD Result</a></li> 
                                        </ol>
                                    </nav>
                                    <!-- breadcrumb End -->
                                </div>
