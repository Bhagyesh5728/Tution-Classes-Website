...
<div class="row">
<div class="col-sm-8"><h2> <b>Edit Notification</b></h2></div>
...
<td ><input name="msg" style="width: 500px;" value="<?php echo $r['msg'];  ?>"></td>


<td>


<a href="deletemsg.php?a=<?php echo $r['id'];  ?>"  class="update" title="Delete" data-toggle="tooltip"><i >Update</i></a>
</td>
</tr>
